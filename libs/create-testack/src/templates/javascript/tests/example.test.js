...
// "fixtures_path": "./libs/create-testack/src/templates/javascript/fixtures/"
...
describe('using testack in a jest environment', function() {
  ...
  beforeAll(async () => {
    ...
    mongoose.connect(`${this.global.testack.providers.mongodb.DATABASE_URL}db`,{useNewUrlParser: true, useUnifiedTopology: true});
